...
local globalKeys = myTable.join(
  ...
  awful.key({ modkey, altkey }, "q", function () awful.util.spawn( "rofi -show power-menu -no-show-icons -modi power-menu:/home/miquel/.local/bin/rofi-power-menu" ) end,
    ...
    awful.key({ modkey }, "t", function () awful.util.spawn( "rofi -show window") end,
        {description = "Launch rofi windows.", group = "Hotkeys" }),
    ...
    awful.key({}, "XF86AudioMute",
        -- function ()
        --     os.execute(string.format("amixer -q set %s ", beautiful.volume.togglechannel or beautiful.volume.channel))
        --     beautiful.volume.update() end,
